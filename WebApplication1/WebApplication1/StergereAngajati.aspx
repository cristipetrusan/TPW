...
&nbsp;<asp:TextBox ID="TextBoxPrenume" runat="server"></asp:TextBox>
    ...
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="NR_CRT" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleted="GridView1_OnRowDeleted">
        <Columns>
